...
class CartModel extends Model {
  ...
  void addCartItem(CartProduct cartProduct) {
    ...
    FirebaseFirestore.instance.collection('users').doc(user?.currentUser?.uid)
  ...
  double getProductsPrice() {
    ...
    for (CartProduct cp in products) {
      if (cp.productData != null) {
        price += cp.quantity! * cp.productData!.price!;
      }
    }
    return price;
  }
  ...
  Future<String?> finishOrder() async {
    ...
    await FirebaseFirestore.instance.collection('users').doc(user!.currentUser!.uid)
    ...
    QuerySnapshot query = await FirebaseFirestore.instance.collection('users')
        .doc(user!.currentUser!.uid).collection('cart').get();
